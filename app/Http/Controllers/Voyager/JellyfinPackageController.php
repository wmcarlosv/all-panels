...
use App\Models\JellyfinPackage;
use App\Models\JellyFin;

class JellyfinPackageController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $server = JellyfinServer::find($dataTypeContent->jellyfinserver_id);
        $libraries = [];
        ...
        if($server){
            ...
            $libraries = $this->jellyfin->get_libaries();
        }

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','libraries'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $server = JellyfinServer::find($request->jellyfinserver_id);
        ...
        if(!empty($request->libraries)){ 
            ...
            $request->merge(['libraries'=>str_replace('"','',implode(',',$libraries))]);
        }
    ...
    public function get_jellyfin_packages_by_server($serverid){
        $packages = JellyfinPackage::where('jellyfinserver_id',$serverid)->get();
