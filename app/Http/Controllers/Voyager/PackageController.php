...
class PackageController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $server = Server::findorfail($dataTypeContent->server_id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->merge(['libraries'=>implode(',',$request->libraries)]);
    ...
    public function getPackagesByserver($server_id){
        $packages = Package::where('server_id',$server_id)->get();
